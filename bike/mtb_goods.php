				...
				<section>
					...
					<div class="row row-cols-3 ml-4 mr-5 mt-5">
						...
						<!-- <form action="goods_detail.php" method="GET">
							<div class="col mb-4">
								<div class="card h-100">
									<img class="card-img-top" src="images/goods/mtb_goods_1-1.jpg" alt="Card image">
									<div class="card-body">
										<h4 class="card-title" style="color: black;">S-Works Turbo Levo SL</h4>
										<p class="card-text" style="color: black;">₩14,900,000</p>
										<input type="hidden" name="kinds" value="mtb">
						...
						<?php
							...
							// 쿼리 전송
							$query = "SELECT * FROM goods_detail WHERE prod_cate='mtb_bikes'";
							...
							$query = "SELECT * FROM goods_detail WHERE prod_cate='mtb_bikes' ORDER BY id ASC LIMIT $s_point,$list";
