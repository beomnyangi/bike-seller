	...
	<body class="text-center" style="margin-top: 10%;">
		<article class="container row-cols-2 d-flex align-items-center justify-content-center">
			<div class="col">
                ...
                <form action="mypage_profile_modify_result.php" method="POST" role="form" onsubmit="return myFunction()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="inputEmail" name="inputEmail" placeholder="이메일 주소를 입력해주세요" readonly>
                    </div>

					<!-- <div class="form-group">
                        <label class="d-flex align-items-center justify-content-left" for="inputPassword">*현재 비밀번호</label>
                        <input type="password" id="inputPassword_old" name="inputPassword_old" placeholder="비밀번호를 입력해주세요">
                    </div>
                    <div class="form-group">
...
&copy; Bike Seller Components. All Rights Reserved.
		...
		<script src="mypage_profile_modify_check.js"></script>
		...
		<?php
			...
			$id = $result_row['id'];
			if($id_value == $id){
				echo "<script>document.getElementById(\"inputName\").value = \"$result_row[name]\";</script>";
				echo "<script>document.getElementById(\"inputEmail\").value = \"$result_row[email]\";</script>";
				echo "<script>document.getElementById(\"number\").value = \"$result_row[contact]\";</script>";
				echo "<script>document.getElementById(\"postcode\").value = \"$result_row[postcode]\";</script>";
				echo "<script>document.getElementById(\"address\").value = \"$result_row[address]\";</script>";
				echo "<script>document.getElementById(\"address2\").value = \"$result_row[address_detail]\";</script>";
