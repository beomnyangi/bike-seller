	...
	<body class="is-preload">
		...
		<div id="page-wrapper">
			...
			<article id="main_road">
				...
				$query = "SELECT * FROM goods_detail WHERE prod_cate='road_bikes'";
				...
				$query = "SELECT * FROM goods_detail WHERE prod_cate='road_bikes' ORDER BY id ASC LIMIT $s_point,$list";
